...
function MadLibs(onSubmit) {
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                <label>Plural Noun 1:</label>
                <input type="text" name="pluralNoun1" 
                value={formData.pluralNoun1} 
                onChange={handleChange} />
            </div>
            <div>
                <label>Plural Noun 2:</label>
                <input type="text" name="pluralNoun2" 
                value={formData.pluralNoun2} 
                onChange={handleChange} />
            </div>
            <div>
                <label>Plural Noun 3:</label>
                <input type="text" name="pluralNoun3" 
                value={formData.pluralNoun3} 
                onChange={handleChange} />
            </div>
            <div>
                <label>Verb Present Tense:</label>
                <input type="text" name="verbPresTense" 
                value={formData.verbPresTense} 
                onChange={handleChange} />
            </div>
            <div>
                <label>Same Verb Past Tense:</label>
                <input type="text" name="sameVerbPastTense" 
